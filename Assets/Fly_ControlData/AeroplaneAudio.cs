...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplaneAudio : MonoBehaviour
    {
        ...
        public class AdvancedSetttings // A class for storing the advanced options.
        {
            ...
            public float engineMaxDistance = 3000f;                 // The max distance of the engine audio source.
            ...
            public float windMinDistance = 50f;                     // The min distance of the wind audio source.
            public float windMaxDistance = 3000f;                    // The max distance of the wind audio source.
        ...
        [SerializeField, Header("循环的引擎声音，其音高和音量受飞机的油门设置影响")] private AudioClip m_EngineSound;                     // Looped engine sound, whose pitch and volume are affected by the plane's throttle setting.
        [SerializeField] private float m_EngineMinThrottlePitch = 0.4f;       // Pitch of the engine sound when at minimum throttle.
        [SerializeField] private float m_EngineMaxThrottlePitch = 1f;         // Pitch of the engine sound when at maximum throttle.
        ...
        [SerializeField, Header("环形风声，其音高和音量受飞机速度影响。")] private AudioClip m_WindSound;                       // Looped wind sound, whose pitch and volume are affected by the plane's velocity.
        ...
        private void Update()
        {
            ...
            //                                             m_Plane.EnginePower);
            m_EngineSoundSource.volume = m_AdvancedSetttings.engineMasterVolume;//引擎声音太大，暂时这么些
