...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplanePropellerAnimator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            //更新：由于螺旋桨模型是手动赋值的，某些螺旋桨轴心需要调整，所以会存在挂上的模型实质是空物体，而
            //子物体才是真正的模型，所以使用此代码更为合适寻找模型本体方便达到一定的转速后隐藏模型本身。
            m_PropellorModelRenderer = m_PropellorModel.GetComponentInChildren<Renderer>();
