...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    //[RequireComponent(typeof (UnityStandardAssets.Utility.WaypointProgressTracker))]//路线管理器，不是必须
    public class AeroplaneAiControl : MonoBehaviour
    {
        ...
        [SerializeField] private Transform m_Target = null;                    // the target to fly towards
