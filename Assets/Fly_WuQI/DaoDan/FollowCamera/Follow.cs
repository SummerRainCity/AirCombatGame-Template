...
{
    [ExecuteInEditMode]
    public class Follow : PivotBasedCameraRig
    {
        ...
        private Vector3 m_RollUp = new Vector3(0,10,0);// The roll of the camera around the z axis ( generally this will always just be up ) -- Vector3.up
